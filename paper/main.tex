...
Schedule comparisons show that non-constant decay schedules substantially outperform constant baselines, reducing regret by $28$--$41\%$ relative to a well-tuned constant $\beta = 1.5\beta_c$.
\end{abstract}
