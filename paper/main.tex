...
% ======================================================================
\begin{abstract}
Game-theoretic formulations of reinforcement learning from human feedback (RLHF)---including NLHF~\citep{munos2024nash}, INPO~\citep{inpo2025}, and SPO~\citep{starlhf2024}---model alignment as a strategic interaction between a policy and an adversary, yet all operate exclusively in discrete time.
